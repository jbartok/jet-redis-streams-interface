...
public final class TradeGenerator {
    ...
    public static BatchSource<Trade> tradeSource(int numTickers, int tradesPerSec, long timeoutSeconds) {
    ...
    private void generateTrades(SourceBuilder.SourceBuffer<Trade> buf) {
